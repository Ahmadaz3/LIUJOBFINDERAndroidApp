...
$Instructort_Email = addslashes(strip_tags($_POST['Instructort_Email']));
...
// check information 
$query_1 = "SELECT * FROM Instructor WHERE Instructort_Email='$Instructort_Email'";
$result = mysqli_query($con,$query_1);

if (mysqli_num_rows($result)<1) {
    // Insert data into the Student table
    $sql1 = "INSERT INTO Instructor (First_name,Last_name,Instructort_Email,Password,Major,Campus)
         VALUES ('$First_name','$Last_name','$Instructort_Email','$Password','$Major','$Campus')";
    mysqli_query($con, $sql1) or die("Can't add record to the Student table");
    
    // Insert data into the user table
    $sql2 = "INSERT INTO users(id,email,password)
         VALUES (LAST_INSERT_ID(),'$Instructort_Email','$Password')";
